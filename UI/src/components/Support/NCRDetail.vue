        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-6">
              ...
              <template v-else>
                <label>Date</label>
                <p>{{ momentTS(form.verificationDate) }}</p>
              </template>
            </div>
            <div class="col-6">
              <fg-input
          ...
          <div class="row">
            <div class="col text-right pb-4">
              <p-button
                ...
                >Close</p-button
              >
              <p-button class="ml-3" type="info" @click="editData" round
                >Edit</p-button
              >
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    editData() {
      this.$store.commit("setBusNCREntry", true);
