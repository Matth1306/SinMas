        ...
        <card>
          <template slot="header">
            ...
            <p class="card-category">
              ...
              >BinarCode</a>. Please checkout the
              <a
        ...
        <card>
          ...
          <div class="row">
            <div class="col-md-12 text-center">
              ...
              <p-button type="primary" @click.native="modals.classic = true">Classic modal</p-button>
              <p-button type="info" @click.native="modals.notice = true">Notice modal</p-button>
              <p-button @click.native="modals.mini = true">Small alert modal</p-button>
