<template>
  <div class="sales-overview">
    <div class="row" style="height: 320px">
          ...
          <div class="card-body w-100 position-relative p-0">
            ...
            <div class="pie-sales col-md-6 px-0 position-absolute">
              <chart-non-card
                ...
                :extra-options="pieProvince.extraOptions"
                chart-type="Pie"
              ></chart-non-card>
            </div>
          </div>
      ...
      <div v-show="!isReseller" class="card-container col-md-4">
        <div class="card">
          ...
          <div class="card-body w-100 position-relative p-0">
            ...
            <div class="pie-sales col-md-6 px-0 position-absolute">
              <chart-non-card
                ...
                :extra-options="pieIndustry.extraOptions"
                chart-type="Pie"
              ></chart-non-card>
            </div>
          </div>
        ...
        <div class="card-map card">
          ...
          <div class="card-body px-0">
            <div class="w-100 h-100 row">
              <div class="table-container col-md-2">
                <el-table :data="tableDataProvince[1]">
                  <el-table-column
                    v-for="header in tableDataProvince[0]"
                    :key="header.name"
                    :label="header.name"
              ...
              <div id="mapsite" class="col-md-10 map-local px-0"></div>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  created() {
    ...
    axios
      .get(
        "http://103.126.226.54:4000/api/sites/" +
          this.$store.state.userId +
          "/show",
        { headers: { token: this.$store.state.tokenId } }
      )
