  ...
  <div class="admin-site">
    <div class="card-form-container">
      <div v-if="stateForm" class="card form p-4">
        <div class="card-header mb-4">Form Site</div>
        <div class="card-body p-0">
          <div class="row">
            <div class="col-6">
              <div class="row">
                <label class="control-label col-12">Select Distributor</label>
                <el-select
                  class="select-default col-12"
                  v-model="formSite.associateRole[1]"
            ...
            <div class="col-6">
              <div class="row">
                <label class="control-label col-12">Select Reseller</label>
                <el-select
                  class="select-default col-12"
                  v-model="formSite.associateRole[2]"
          ...
          <div class="row">
            <div class="col-6">
              <fg-input
                ...
                v-model="formSite.compAddress"
              ></fg-input>
            </div>
            <div class="col-6">
              <fg-input
                label="Company Phone"
                v-model="formSite.compTlp"
              ></fg-input>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-12 card">
        <div class="card-header row px-0 py-2">
          <div class="col-6 d-flex flex-column justify-content-center">
            <h4 class="m-0">Sites List</h4>
          </div>
          <div
            v-if="isAdminShow"
            class="col-6 d-flex flex-row justify-content-end"
          >
            <p-button type="info" @click="addForm" round>Add Site</p-button>
          </div>
        </div>
