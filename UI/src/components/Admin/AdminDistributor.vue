<template>
  <div class="admin-distributor">
    <div class="card-form-container">
      <div v-if="stateForm" class="card form p-4">
        <div class="card-header">Form Distributor</div>
          ...
          <div class="row">
            ...
            <div class="col-6">
              <fg-input
                label="Password"
                type="password"
                v-model="formDistributor.password"
              ></fg-input>
            </div>
          </div>
          <div class="row">
            <div class="col-6">
              <fg-input
                v-model="formDistributor.fullName"
                label="Full Name"
              ></fg-input>
            </div>
            <div class="col-6">
              <fg-input
                label="Company Name"
                v-model="formDistributor.compName"
              ></fg-input>
            </div>
          </div>
          <div class="row">
            <div class="col-6">
              <fg-input
                ...
                v-model="formDistributor.compAddress"
              ></fg-input>
            </div>
            <div class="col-6">
              <fg-input
                label="Company Phone"
                v-model="formDistributor.compTlp"
              ></fg-input>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-12 card">
        <div class="card-header row px-0 py-2">
          <div class="col-6 d-flex flex-column justify-content-center">
            <h4 class="m-0">Distributor List</h4>
          </div>
          <div
            v-if="isAdminShow"
            class="col-6 d-flex flex-row justify-content-end"
          >
            <p-button type="info" @click="addForm" round
              >Add Distributor</p-button
            >
          </div>
        </div>
